        ...
        <div class="d-flex flex-column px-2">
            ...
            <div class="d-flex my-2 mx-0 mx-lg-4 px-1 gap-1">
                <div class="p-2 d-flex align-items-center">
                    <div class="">
                        <a type="button" href="admin/admin-verification.php"
                ...
                <div class="d-flex flex-column flex-lg-row col align-items-lg-center justify-content-between p-1">
                    ...
                    <ol class="breadcrumb p-lg-2">
                        ...
                        <li class="breadcrumb-item"><a class="text-decoration-none"
                                href="admin/admin-verification.php">Verification</a></li>
                    </ol>
                </div>
            </div>
            ...
            <div class="d-flex row mx-1 mx-lg-4 gap-4">
                ...
                <div>
                    <form action="../php/verifikasiController.php" method="post"
                        class="form container rounded-3 d-flex flex-column col col-sm-8 col-md-7 col-lg-6 col-xxl-5 p-5 gap-3 text-center"
                        enctype="multipart/form-data">
                        <h2 class="fw-bold fs-1">Register Form</h2>
                        <div class="form-floating">
                            <input type="text" readonly class="form-control text text-field" name="username"
                                value="<?=$user['username']?>" title="nama">
                            <label class="text">Username</label>
                        </div>
                        <div class="form-floating">
                            <input type="text" readonly class="form-control text text-field focus-none" name="email"
                                value="<?=$user['email']?>" title="email">
                            <label>Email</label>
                        </div>
                        <div class="form-floating">
                            <select class="form-select text text-field" id="floatingSelect" aria-label="Jabatan"
                                name="jabatan">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control text text-field" placeholder="Gaji"
                                aria-label="Username" aria-describedby="basic-addon1" name="gaji">
                        </div>
                        <div class="d-flex">
                            <input type="submit" value="Verifikasi" name="verifikasi"
