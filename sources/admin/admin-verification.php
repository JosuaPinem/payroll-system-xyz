...
<body class="d-none">
    ...
    <div class="content col d-flex flex-column gap-3 mb-5">
        ...
        <div class="d-flex flex-column gap-4 px-2">
            ...
            <!-- Content Body -->
            <div class="d-flex  flex-column mx-0 mx-lg-4 px-2 gap-3">
                <!-- Verification List -->
                <div class="flex-container rounded-4 shadow border-0 p-2">
                    <div class="d-flex p-3">
                        <form class="d-flex align-items-center gap-2" action="" method="post">
                            <input type="text" name="cari" class="form-control text-field" id="search" placeholder="Search">
                            <button type="submit" name="search" class="btn btn-primary material-icons-round">&#xe8b6</button>
                        </form>
                    </div>
                    <table class="table table-hover">
                        <thead>
                            <tr class="d-flex col p-1">
                                ...
                                <th class="col col-md-2 d-none d-sm-flex p-1 align-items-center justify-content-center text">
                                    Kode</th>
                                <th class="col col-md-2 d-none d-sm-flex p-1 align-items-center justify-content-center text">
                                    Username
                                </th>
                                <th class="col col-md-3 d-none d-md-flex p-1 align-items-center justify-content-center text">
                                    Email
                                </th>
                        ...
                        <tbody>
                            ...
                            while ($u = mysqli_fetch_assoc($user2)) :
                                $kode = $u['kode_karyawan'];
                                $get = mysqli_query($koneksi, "SELECT * FROM data_karyawan WHERE kode_karyawan = '$kode'");
                            ...
                            ?>
                                    <tr class="d-flex col p-1 text-center">
                                        <td class="col-8 col-sm-4 col-md-3 d-flex gap-2 p-1 align-items-center">
                                            <span class="text"><?= $g['nama']; ?></span>
                                        </td>
                                        <td class="col col-md-2 d-none d-sm-flex p-1 align-items-center justify-content-center text">
                                            <span class="text"><?= $u['kode_karyawan']; ?></span>
                                        </td>
                                        <td class="col col-md-2 d-none d-sm-flex p-1 align-items-center justify-content-center text">
                                            <span class="text"><?= $u['username']; ?></span>
                                        </td>
                                        <td class="col col-md-3 d-none d-md-flex p-1 align-items-center justify-content-center text">
                                            <span class="text"><?= $u['email']; ?></span>
                                        </td>
                                        <td class="col d-flex p-1 align-items-center justify-content-center gap-1">
                                            <a href="../verifikasi.php?user=<?= $u['username'] ?>" type="button" class="btn btn-primary d-flex align-items-center p-md-2 p-1" title="confirmation">
                                                <i class="material-icons">&#xe6b1</i>
                                            </a>
                                            <a style="text-decoration:none;" onclick="return confirm('Apakah anda ingin menolak verifikasi <?= $v['username'] ?>')" href="../../php/tolakVerifikasiController.php?kode=<?= $u['kode_karyawan'] ?>">
                                                <button type="button" class="btn btn-danger d-flex align-items-center p-md-2 p-1" title="reject">
