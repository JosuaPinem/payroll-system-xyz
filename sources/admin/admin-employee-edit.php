            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <div class="dropdown d-flex">
                    ...
                    <button class="btn d-flex align-items-center gap-3" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img id="profile-img" src="../user-img/<?php echo $query3['foto'] ?>" class="rounded-circle bg-light shadow-sm col-2" alt="Avatar" />
        ...
        <div class="d-flex flex-column px-2 gap-3">
            ...
            <div class="d-flex my-2 mx-0 mx-lg-4 px-1 gap-1">
                <div class="p-2 d-flex align-items-center">
                    <div class="d-flex">
                        <a type="button" href="./admin-employee-list.php" class="d-flex rounded-circle p-1 btn btn-primary align-items-center justify-content-center">
                ...
                <div class="d-flex flex-column flex-lg-row col align-items-lg-center justify-content-between p-1">
                    ...
                    <ol class="d-flex my-0 breadcrumb p-lg-2">
                        <li class="breadcrumb-item"><a class="text-decoration-none" href="./admin-employee-list.php">Employee List</a>
                        </li>
                            ...
                            <div class="d-flex flex-column gap-3">
                                <div class="d-flex px-3 py-2 gap-4 background rounded-4">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <input class="form-control text text-field profile-info" type="text" value="<?= $query['nama']; ?>" aria-label="readonly input example" readonly>
                                    </div>
                                </div>
                                <div class="d-flex px-3 py-2 gap-4 background rounded-4">
                                    <div class="d-flex gap-4">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <input class="form-control text text-field profile-info" type="text" value="<?= $query2['email']; ?>" aria-label="readonly input example" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex px-3 py-2 gap-4 background rounded-4">
                                    <div class="d-flex gap-4">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <input class="form-control text text-field profile-info" type="text" value="<?= $query['nip']; ?>" aria-label="readonly input example" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex flex-column gap-3">
                                <div class="d-flex px-3 py-2 gap-4 background rounded-4">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <input class="form-control text text-field profile-info" id="datepicker" type="text" value="<?= $query['tanggal']; ?>" aria-label="readonly input example" readonly>
                                    </div>
                                </div>
                                <div class="d-flex px-3 py-2 gap-4 background rounded-4">
                                    <div class="d-flex gap-4">
                                ...
                                <div class="d-flex px-3 py-2 gap-4 background rounded-4">
                                    <div class="d-flex gap-4">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <input class="form-control text text-field profile-info" type="text" value="<?= $query['alamat']; ?>" aria-label="readonly input example" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex col flex-column gap-3">
                                        <div class="d-flex px-3 py-2 gap-4 background rounded-4">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                ?>
                                                <select name="position" class="form-control user-edit form-control text text-field profile-info" aria-label="Default select example">
                                        ...
                                        <div class="d-flex px-3 py-2 gap-4 background rounded-4">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div class="input-group d-flex gap-2">
                                                    ...
                                                    <input class="user-edit form-control text text-field profile-info" name="gaji" type="text" value="<?= $query['gaji']; ?>" aria-label="readonly input example" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
