                    ...
                    <div class="d-flex flex-column flex-sm-row col p-3 gap-3">
                        ...
                        <div class="d-flex col">
                            <form class="d-flex align-items-center gap-2" action="" method="post">
                                <input type="text" class="form-control text-field" id="search" name="cari" placeholder="Search">
                        ...
                        <form action="../../php/runPayrollController.php" method="post">
                            <div class="d-flex gap-1">
                                <!-- Button Bonus -->
                                <button type="button" class="btn btn-primary d-flex gap-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                    <i class="material-icons-round">&#xe850</i>
                                    <span>Add Bonus</span>
                                </button>
                                <!-- Modal Bonus -->
                                            ...
                                            <div class="modal-body">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" name="jumlahBonus" class="form-control text-success text-field" aria-label="Username" placeholder="1000000" aria-describedby="basic-addon1">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <button type="submit" name="tambahBonus" class="btn btn-primary" data-bs-dismiss="modal">Tambah</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Button Payroll -->
                                <button type="submit" onclick="return confirm('Apakah anda ingin membayar gaji seluruh karyawan?')" class="btn btn-success d-flex gap-2" name="run"><i class="material-icons-round">&#xe1c4</i>
                                    <span>Run Payroll</span></button>
                            </div>
                        </form>
                    </div>
                                ...
                                ?>
                                    <tr class="d-flex col p-1">
                                        ...
                                        <td class="col d-flex p-1 align-items-center justify-content-center gap-1">
                                            <a href="admin-payroll-edit.php?kode=<?= $u['kode_karyawan'] ?>" type="button" class="btn btn-primary d-flex align-items-center p-md-2 p-1" title="edit">
                                                <i class="material-icons-round">&#xe3c9</i>
                                            </a>
                                            <a type="button" name="bayarGaji" href="admin-payroll.php?kode=<?= $u['kode_karyawan'] ?>" class="btn btn-success d-flex align-items-center p-md-2 p-1" title="delete" onclick="return confirm('Apakah anda ingin membayar gaji <?= $u['nama'] ?> ?')">
