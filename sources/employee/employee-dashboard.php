...
<body class="d-flex">
    ...
    <div class="content col d-flex flex-column gap-3 mb-5">
        ...
        <div class="d-flex flex-column gap-4 px-2">
            ...
            <!-- Content Body -->
            <div class="d-flex col flex-column flex-xl-row mx-1 mx-lg-4 gap-4 mb-4">
                <!-- Container One -->
                <div class="d-flex col col-xl-9 flex-column gap-4">
                    <!-- Row One -->
                    <div class="d-flex gap-4 flex-column">
                        <div class="d-flex gap-4 flex-column flex-xxl-row">
