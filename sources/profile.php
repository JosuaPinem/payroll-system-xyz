                ...
                <div class="d-flex flex-column flex-lg-row col align-items-lg-center justify-content-between p-1">
                    ...
                    <ol class="d-flex my-0 breadcrumb p-lg-2">
                        <li class="breadcrumb-item"><a class="text-decoration-none"
                                href="admin/admin-dashboard.html">Home</a>
                        </li>
                ...
                <div class="flex-container d-flex flex-column gap-3 p-4 rounded-4 ">
                    ...
                    <div class="d-flex flex-column gap-3 mt-2">
                        <div class="d-flex">
                            ...
                            <a href="#" class="btn btn-primary ms-auto d-flex p-2" id="edit-profile">
                        ...
                        <div class="d-flex flex-column flex-md-row gap-3 ">
                            <div class="d-flex flex-column gap-3">
                                ...
                                <div class="d-flex px-3 py-2 gap-4 background rounded-4">
                                    <div class="d-flex gap-4">
                                        <div class="d-flex align-items-center">
                                            <i class="material-icons-round fs-1">&#xe0cd</i>
                                        </div>
                                        <div class="d-flex flex-column">
                                            <span class="fw-semibold">Phone</span>
                                            <input class="user-edit form-control text text-field profile-info"
                                                type="text" value="081234567890" aria-label="readonly input example"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
